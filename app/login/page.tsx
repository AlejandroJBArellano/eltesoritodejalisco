      ...
      <div className="w-full max-w-md space-y-6 bg-[#242424] p-8 rounded-2xl border border-white/10 shadow-2xl">
        ...
        <form className="space-y-4" action={login}>
          <div className="space-y-3">
            <div>
              <label htmlFor="email-address" className="text-[10px] font-extrabold text-[#E0E0E0]/50 uppercase tracking-widest block mb-1">
                Correo electrónico
              </label>
              <input
                id="email-address"
            ...
            <div>
              <label htmlFor="password" className="text-[10px] font-extrabold text-[#E0E0E0]/50 uppercase tracking-widest block mb-1">
                Contraseña
              </label>
              <input
                id="password"
        ...
        <div className="flex items-center justify-center gap-3 my-2">
          ...
          <span className="text-[10px] font-black text-[#E0E0E0]/30 uppercase tracking-widest">O</span>
          <div className="h-px flex-1 bg-white/10" />
        </div>
