...
export function SettingsForm({ initialTenant }: SettingsFormProps) {
  ...
  // Live preview state
  const [primaryColor, setPrimaryColor] = useState(initialTenant.primary_color || "#FFB7CE");
    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl mx-auto pb-12">
      ...
      {success && (
        <div className="rounded-xl p-4 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-sm font-bold flex items-center gap-2.5">
          ...
          <span>¡Configuración actualizada con éxito! Los cambios se aplicaron de inmediato.</span>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="rounded-2xl bg-[#242424] border border-white/5 p-6 space-y-4">
            <h3 className="text-sm font-bold text-[#E0E0E0]/50 uppercase tracking-wider flex items-center gap-2 mb-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/10 bg-[#181818] px-4 py-2.5 text-sm text-[#E0E0E0] outline-none focus:border-blue-500 transition"
                />
              </div>
              <div>
                <label className="text-xs font-bold text-[#E0E0E0]/40 uppercase tracking-wider block mb-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/10 bg-[#181818] px-4 py-2.5 text-sm text-[#E0E0E0] outline-none focus:border-blue-500 transition font-mono uppercase"
                />
              </div>
              <div>
                <label className="text-xs font-bold text-[#E0E0E0]/40 uppercase tracking-wider block mb-1">
        ...
        <div className="space-y-6">
          <div className="rounded-2xl bg-[#242424] border border-white/5 p-6 space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <input
                  ...
                  value={primaryColor}
                  onChange={(e) => setPrimaryColor(e.target.value)}
                  className="flex-1 rounded-xl border border-white/10 bg-[#181818] px-4 py-2 text-sm text-[#E0E0E0] outline-none focus:border-blue-500 font-mono"
                />
              </div>
            </div>
            ...
            {/* Live Preview Box */}
            <div className="border border-white/5 rounded-xl p-4 bg-black/20 text-center space-y-2 mt-4">
              <span className="text-[10px] font-bold text-[#E0E0E0]/40 uppercase tracking-widest block">Vista Previa de Botón</span>
              <button
                type="button"
