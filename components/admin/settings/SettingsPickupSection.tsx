    ...
    >
      <div className="flex items-center justify-between border-b border-border pb-3">
        ...
        {initialTenant.stripe_charges_enabled ? (
          ...
          <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-dark/40 text-text-light/40 border border-border">
            Inactivo
          </span>
        )}
      </div>
      ...
      <div className="rounded-xl bg-dark/40 border border-border/70 p-4 space-y-3">
