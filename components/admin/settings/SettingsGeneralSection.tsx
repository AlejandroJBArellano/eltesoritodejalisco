    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl bg-card border border-border p-6 space-y-6 transition hover:border-text-light/20">
        ...
        <p className="text-xs text-text-light/60 leading-relaxed">
          Configura los accesos y redes que se imprimirán en el pie de página de
          tus tickets de venta. El sistema imprimirá automáticamente un QR para
          tu menú digital de{" "}
          <strong className="text-text-light">Kittn Pickup</strong> y, si lo
          configuras, un segundo QR para{" "}
          <strong className="text-text-light">Reseñas en Google Maps</strong>.
        </p>

        <div className="space-y-4">
          <div>
            <label className="text-xs font-bold text-text-light/60 uppercase tracking-wider flex items-center gap-1.5 mb-1.5">
              <Star className="h-3.5 w-3.5 text-amber-400" /> Enlace para
              Reseñas (Google Maps / TripAdvisor)
            </label>
            <input
              type="url"
            ...
            <p className="text-[10px] text-text-light/40 mt-1.5">
              ...
              paralelo: <strong>[Menú en Línea]</strong> y{" "}
              <strong>[Califícanos]</strong>. Si lo dejas vacío, solo se
              mostrará el QR del menú.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-[10px] text-text-light/40 mt-1.5">
              ...
              códigos QR (ej. tus usuarios de Instagram, TikTok o promociones).
            </p>
          </div>
        </div>
      </div>
