  ...
  return (
    <div className="rounded-xl bg-card border border-border p-6 space-y-6 transition hover:border-text-light/20 shadow-sm">
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="relative max-w-xs">
            <input
              ...
              placeholder="Ej. 4.06"
              className="w-full rounded-lg border border-border bg-secondary px-4 py-2.5 pr-10 text-sm text-text-light font-mono tabular-nums outline-none focus:border-primary focus:ring-1 focus:ring-primary transition"
            />
        ...
        <div className="rounded-xl bg-secondary border border-border/80 p-4 space-y-3 shadow-inner">
