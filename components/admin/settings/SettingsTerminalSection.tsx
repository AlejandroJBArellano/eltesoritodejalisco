        ...
        <div>
          ...
          <div className="relative max-w-xs">
            <input
              ...
              placeholder="Ej. 4.06"
              className="w-full rounded-lg border border-border bg-dark/40 px-4 py-2.5 pr-10 text-sm text-text-light font-mono tabular-nums outline-none focus:border-primary focus:ring-1 focus:ring-primary transition"
            />
