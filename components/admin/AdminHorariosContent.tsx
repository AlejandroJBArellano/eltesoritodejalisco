        ...
        <div className="mt-6 mb-8 flex justify-center sm:justify-start">
          <div className="inline-flex p-1 rounded-xl bg-card border border-border shadow-xs">
            <button
              ...
              className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-xs font-black uppercase tracking-wider transition-all cursor-pointer ${
                activeTab === "shifts"
          ...
          <div className="max-w-4xl">
            ...
            <form onSubmit={handleSave} className="space-y-6">
              ...
              <div className="flex justify-end gap-3">
                <Link
                  href="/"
                  className="rounded-lg border border-border px-5 py-2.5 text-xs font-black uppercase tracking-wider text-text-light/60 hover:text-text-light hover:bg-white/5 transition-all"
                >
                  Cancelar
                </Link>
                <button
                  type="submit"
                  disabled={isSaving}
                  className="rounded-lg bg-amber-500 px-6 py-2.5 text-xs font-black uppercase tracking-wider text-background hover:brightness-105 transition-all shadow-lg shadow-amber-500/10 flex items-center gap-2 disabled:opacity-50 cursor-pointer"
                >
                  {isSaving ? (
                    <>
