    ...
    <section className="rounded-xl bg-card p-6 sm:p-8 shadow-sm border border-border">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6 border-b border-border pb-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center gap-2 bg-secondary px-3 py-1.5 rounded-lg border border-border text-xs">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
        ...
        <div className="col-span-2 sm:col-span-1 bg-secondary p-4 rounded-xl border border-border">
          <span className="text-[10px] font-extrabold text-text-light/50 uppercase tracking-wider block">
            Top Producto
          </span>
              ...
              >
                <div className="flex items-center justify-between text-xs mb-1.5 gap-2">
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    <span className="hidden sm:inline-block text-[10px] font-bold text-text-light/40 uppercase bg-secondary border border-border px-1.5 py-0.5 rounded-md">
                ...
                {/* Progress bar track */}
                <div className="h-3 w-full bg-secondary border border-border/60 rounded-full overflow-hidden p-0.5">
                  <div
