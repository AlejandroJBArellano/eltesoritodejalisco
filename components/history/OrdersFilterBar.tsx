      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="relative w-full md:w-72">
          ...
          <input
            ...
            className="w-full bg-dark/40 border border-border rounded-lg pl-10 pr-4 py-2 text-xs text-text-light placeholder:text-text-light/30 focus:border-primary focus:outline-none transition-all font-medium"
          />
        </div>
        ...
        <div className="flex items-center gap-2.5 w-full md:w-auto overflow-x-auto pb-1 md:pb-0 flex-wrap">
          ...
          <div className="relative flex items-center">
            <input
              ...
              className="bg-dark/40 border border-border rounded-lg px-3 py-2 text-xs text-text-light focus:border-primary focus:outline-none transition-all cursor-pointer font-mono"
            />
          </div>
          ...
          <select
            ...
            className="bg-dark/40 border border-border rounded-lg px-3 py-2 text-xs text-text-light focus:border-primary focus:outline-none transition-all cursor-pointer font-medium"
          >
