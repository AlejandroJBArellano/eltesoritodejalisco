...
export default function OrdersPOS({ onClickCancel, cancelArmedId }: {
    ...
    const filteredOrders = useMemo(() => {
        return orders.filter((o) => {
            ...
            if (sourceFilter === "PICKUP_APP" && o.source !== "PICKUP_APP") return false;
        ...
        <div className="hidden md:block space-y-3">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-1.5 bg-dark/40 p-1 rounded-xl border border-border">
                    ...
                    >
                        <span>Todas</span>
                        <span className="text-[10px] opacity-70 font-mono font-bold">({orders.length})</span>
                    </button>
                    <button
                        type="button"
                ...
                <div className="flex items-center gap-1.5 bg-dark/40 p-1 rounded-xl border border-border">
                    ...
                    >
                        ...
                        <span className="text-[10px] opacity-70 font-mono font-bold">({posCount})</span>
                    </button>
                    <button
                        type="button"
