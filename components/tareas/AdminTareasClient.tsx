...
export function AdminTareasClient({
  ...
  const [newTaskFrequency, setNewTaskFrequency] =
  ...
  const [editingTaskFrequency, setEditingTaskFrequency] =
    useState<TaskFrequency>("DAILY");
  const [editingTaskRequiresPhoto, setEditingTaskRequiresPhoto] =
    useState(false);
  ...
  }, [execSearch, execStatusFilter, execSortField, execSortDir, execPage]);
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                value={
                  editingTaskId ? editingTaskCategoryId : newTaskCategoryId
                }
                onChange={(e) =>
                  editingTaskId
