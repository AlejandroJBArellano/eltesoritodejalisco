    ...
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border pb-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          className="rounded-lg border border-border bg-dark/40 px-4 py-2 text-xs font-bold text-text-light outline-none focus:border-primary transition-all scheme-dark cursor-pointer font-mono tabular-nums"
        />
      </div>
    </div>
  );
