      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-card">
          <div className="flex items-center gap-2.5">
            {icon}
            <div>
              <h3 className="text-base font-black text-text-light uppercase tracking-tight">
                {title}
              </h3>
              {subtitle && (
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-lg text-text-light/40 hover:text-text-light hover:bg-white/5 transition-colors"
            title="Cerrar (Esc)"
          >
            <X className="h-5 w-5" />
          </button>
