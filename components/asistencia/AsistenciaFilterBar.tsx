  ...
  return (
    <section className="rounded-xl bg-card p-6 shadow-xs border border-border space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border pb-3">
        <h2 className="text-xs font-bold text-text-light/50 uppercase tracking-wider flex items-center gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="rounded-lg bg-primary px-4 py-2 text-xs font-bold text-background hover:brightness-110 active:scale-[0.98] transition-all duration-200 cursor-pointer uppercase tracking-wider flex items-center gap-1.5 shadow-xs"
          >
            <RefreshCw
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div>
          <label className="text-[10px] font-bold text-text-light/50 uppercase tracking-wider block mb-1">
            Empleado
          </label>
          <select
