        ...
        <div className="mt-4 flex flex-wrap items-center gap-4 pt-4 border-t border-border">
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="rounded-lg border border-border bg-dark/40 px-3.5 py-2 text-xs text-text-light outline-none focus:border-primary focus:ring-1 focus:ring-primary"
            />
          </div>
          <div className="flex items-center gap-2">
            <label
