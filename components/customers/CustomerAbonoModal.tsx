      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {method === PaymentMethod.CASH && (
          <div className="space-y-3 bg-dark/40 p-3.5 rounded-xl border border-border">
            ...
            <div className="flex justify-between items-center pt-1 border-t border-border/50 text-xs">
              ...
              <span
                className={`font-black font-mono tabular-nums text-sm ${change > 0 ? "text-emerald-400" : "text-text-light/40"}`}
              >
                ${change.toFixed(2)}
              </span>
            </div>
        ...
        <div className="flex gap-3 pt-2">
          ...
          <button
            ...
            className="flex-1 py-2.5 rounded-lg font-black text-xs uppercase tracking-wider bg-amber-500 hover:bg-amber-400 text-background shadow-lg transition-all disabled:opacity-50 cursor-pointer font-mono tabular-nums"
          >
